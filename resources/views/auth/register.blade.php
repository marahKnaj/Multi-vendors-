...
<div class="container col-xl-5 col-lg-6 col-md-5">
                        ...
                        <div class="p-5">
                            ...
                            @csrf
                                <div class="form-group ">
                                        ...
                                        <input type="text" 
                                            placeholder="First Name" id="name"class="form-control form-control-user @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                            @error('name')
